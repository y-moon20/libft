...
#    Updated: 2020/08/28 02:10:55 by yomoon           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRCS = ft_lstclear.c ft_lstdelone.c ft_lstadd_front.c ft_lstadd_back.c ft_lstlast.c ft_lstiter.c ft_lstsize.c ft_lstnew.c
